...
export function AppearancePreview({ settings, tasks, navigation, preferences, mode }: {
  settings: AppSettings; tasks: PlanItem[]; navigation: NavigationData; preferences: NewTabPreferences; mode: PreviewMode;
}) {
  ...
  return <div ref={host} className="appearance-preview-host">
    ...
    {portalRoot && createPortal(<div inert className={`app extension-app ${appearance}${sidePanel ? " compact" : ""}`}
